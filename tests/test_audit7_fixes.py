"""Tests for Audit VII findings — 12 fixes across 3 cycles.

Cycle 1 (Critical Statistical):
    GPU-VII-1: Inline EB d0=inf returns prior variance (not original)
    GPU-VII-2: eb_df_total=inf when d0=inf + verbose log corrected
    RC-VII-7: Permutation null uses per-gene shuffling (not column reorder)
    STAT-VII-1: mean50 MIXED uses abs(z) for bidirectional detection

Cycle 2 (Validation & Architecture):
    VAL-VII-9: Phase 3 gate falls back to free permutation when stratified fails
    VAL-VII-4: Negative control sampling excludes target genes
    ARCH-VII-1: PreparedCliqueExperiment deep-copies sample_metadata
    STAT-VII-4: Modified Gram-Schmidt orthogonalization

Cycle 3 (Minor):
    RC-VII-1: Bootstrap matching excludes already-matched communities
    RC-VII-5: Bootstrap/permutation thread correlation method
    VAL-VII-2: Degenerate strata warning in stratified permutation
"""
...
# =============================================================================
# GPU-VII-1: Inline EB d0=inf returns prior variance
# =============================================================================
...
# =============================================================================
# GPU-VII-2: eb_df_total and verbose log
# =============================================================================
...
# =============================================================================
# RC-VII-7: Permutation null uses per-gene shuffling
# =============================================================================
...
# =============================================================================
# STAT-VII-1: mean50 MIXED uses abs(z)
# =============================================================================
...
# =============================================================================
# VAL-VII-4: Negative control excludes target genes
# =============================================================================
...
# =============================================================================
# STAT-VII-4: Modified Gram-Schmidt
# =============================================================================
...
# =============================================================================
# VAL-VII-2: Degenerate strata warning
# =============================================================================
