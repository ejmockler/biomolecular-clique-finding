"""
Tests for CLI parameter validation, protocol abstractions, and warning conventions.

Covers:
- Protocol get_conditions: ExperimentalDesign Protocol abstraction replaces
  isinstance checks on concrete MetadataDerivedDesign.
- CLI parameter bounds checking: invalid numeric args (alpha, n-rotations,
  min-targets, workers, etc.) are rejected by argparse validators.
- Warning convention: key modules use logger.warning() for operational
  warnings, not warnings.warn().
"""
...
# =====================================================================
# Protocol abstraction — get_conditions
# =====================================================================
