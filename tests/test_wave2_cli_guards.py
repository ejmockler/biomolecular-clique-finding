"""Tests for Audit II Wave 2: CLI guards and bootstrap fixes.

Covers:
- CLI-1:      Empty contrasts dict crash in validate_baselines
- CLI-2:      contrasts=None AttributeError in differential CLI
- CLI-8:      Empty target gene set wastes compute in validate_baselines
- SET-TEST-4: Bootstrap duplicate DataFrame index from with-replacement sampling
"""
...
# =========================================================================
# CLI-8: Empty target gene set in validate_baselines
# =========================================================================

class TestCLI8EmptyGeneSet:
...
# =========================================================================
# SET-TEST-4: Bootstrap duplicate DataFrame index
# =========================================================================

class TestSETTEST4BootstrapIndex:
