"""Tests for deferred findings XII remediation."""
...
class TestVSNScaleGuard:
    """DF-XII-1: VSN should warn when data appears log-transformed."""
...
class TestEBPriorsDocumentation:
    """DF-XII-2: Verify EB priors comment exists in permutation_gpu.py."""
...
class TestCameraVIFIntegration:
    """DF-XII-3: Camera VIF correction in competitive z-scores."""
...
class TestPhase3CliqueChunking:
    """DF-XII-R2: Phase 3 should chunk by clique count to bound memory."""
...
class TestSilentVIFFallback:
    """DF-XII-R3: VIF fallback should log a warning when engine.data is None."""
...
class TestVSNSkipScaleCheck:
    """DF-XII-R4: VSN should support skip_scale_check parameter."""
...
class TestQRILCBiasNote:
    """DF-XII-R5: QRILC docstring should document truncation bias."""
...
class TestNegativeControlResultRhoBar:
    """DF-XII-R6: NegativeControlResult should store target_inter_gene_correlation."""
...
# ========================================================================
# DF-XIII Tests: Deferred Findings from DF-XII Review Cycle 2
# ========================================================================


class TestD6CameraBackgroundTerm:
    """D6: Camera 1/(G-m) background variance term documentation."""
...
class TestD7RawVsResidualCorrelation:
    """D7: Raw expression vs residual correlation documentation."""
...
class TestD5ControlRhoBarSpotCheck:
    """D5: Control set rho_bar spot-check diagnostic."""
...
class TestD3PreAllocateNullArrays:
    """D3: Pre-allocate null_t/null_log2fc arrays."""
...
class TestD1Phase2MemoryBounding:
    """D1: Phase 2 observed analysis memory bounding."""
...
class TestD4ReturnLog2fc:
    """D4: batched_ols_contrast_test returns log2fc to avoid redundant computation."""
...
class TestD2LazyIndexGeneration:
    """D2: Lazy random index generation via SeedSequence."""
