"""Tests for Audit VI statistical fixes.

STAT-VI-1: squeeze_var d0=inf returns prior variance (not original).
STAT-VI-2: fit_general() filters zero-variance and NaN genes like fit().
"""
...
# ---------------------------------------------------------------------------
# STAT-VI-2: fit_general() gene filtering
# ---------------------------------------------------------------------------
