"""
Tests for CACHE-IV-1 and CACHE-IV-2 audit fixes.

CACHE-IV-1: correlation matrix cache key now hashes full data (was 1% sample).
CACHE-IV-2: weight hash no longer pollutes global RNG via np.random.seed(42).
...
4. Cache key is 32 hex chars (128-bit, was 16/64-bit)
...
# =====================================================================
# CACHE-IV-1: _compute_cache_key correctness
# =====================================================================
...
# =====================================================================
# CACHE-IV-2: No global RNG pollution
# =====================================================================
