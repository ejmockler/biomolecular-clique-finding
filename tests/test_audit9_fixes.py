"""Tests for Audit IX findings — 15 fixes across 3 cycles."""
...
# =============================================================================
# Cycle 1: IO/Data Loading
# =============================================================================


class TestIO1_SoftClipOnlyOutliers:
    """IO-1: Soft-clip should only modify outlier positions, not non-outlier values."""
...
class TestIO2_MADZeroClipToMedian:
    """IO-2: MAD=0 should clip outliers to median, not skip."""
...
class TestIO4_UTF8BOM:
    """IO-4: CSV loader handles UTF-8 BOM encoding."""
...
class TestIO5_QuantileNormFractionalRank:
    """IO-5: Quantile normalization uses np.interp for fractional ranks."""
...
class TestIO8_QualityFlagDtype:
    """IO-8: Quality flags preserve dtype after bitwise OR."""
...
# =============================================================================
# Cycle 2: GPU / Differential
# =============================================================================


class TestGPUIX1_EBDfInf:
    """GPU-IX-1: When d0=inf (no EB moderation), use df_residual not eb_df_total."""
...
class TestGPUIX2_NaNFallback:
    """GPU-IX-2: NaN in input triggers CPU fallback for batched_median_polish."""
...
class TestDIFFIX1_SatterthwaiteDf:
    """DIFF-IX-1: Satterthwaite uses within/between df, not total params."""
...
class TestDIFFIX3_Float64CondCheck:
    """DIFF-IX-3: MLX XtX cast to float64 before condition number check."""
...
# =============================================================================
# Cycle 3: Clique Analysis / Integration
# =============================================================================


class TestCA1_IDSpaceMismatch:
    """CA-1: compare_protein_vs_clique_results handles ID-space mismatch gracefully."""
...
class TestCA2_NaNIndraTargets:
    """CA-2: load_clique_definitions handles NaN n_indra_targets."""
...
class TestCA3_CliqueIdNotRegulator:
    """CA-3: ROAST functions use clique_id (not regulator) as dict key."""
...
class TestCA4_ZeroDivisionGuard:
    """CA-4: No ZeroDivisionError when permutation_results is empty."""
...
class TestCA7_BareExceptLogging:
    """CA-7: Bare except now logs instead of silently swallowing."""
...
class TestINT3_FrozenFractionVerdict:
    """INT-3: frozen_fraction > 0.5 downgrades Phase 3 gate."""
