"""
Tests for Audit II Wave 2 edge-crash fixes.

STAT-CORE-2: UnboundLocalError at max_iter=0 in tukey_median_polish
STAT-CORE-3: AFT ddof=0 bias in impute_aft_model
STAT-CORE-4: All-NaN crash in impute_missing_values
SET-TEST-3:  NaN conditions dimension mismatch in RotationTestEngine.fit()
"""
...
# ---------------------------------------------------------------------------
# STAT-CORE-2: tukey_median_polish with max_iter=0 must not crash
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# STAT-CORE-3: AFT sigma must use ddof=1
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# STAT-CORE-4: All-NaN input must not crash
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# SET-TEST-3: NaN conditions must not cause dimension mismatch in fit()
# ---------------------------------------------------------------------------
