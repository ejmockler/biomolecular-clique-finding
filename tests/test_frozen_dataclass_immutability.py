"""
Tests for frozen dataclass immutability, chunked Neo4j queries, and
single-contrast validation verdict logic.

Covers:
- Frozen dataclass immutability: NDArray fields read-only, lists->tuples,
  dicts->MappingProxyType across RotationPrecomputed, GeneEffects,
  TestResult, UnifiedCliqueResult, PreparedCliqueExperiment.
- Chunked Neo4j queries: discover_regulators() chunks large CURIE lists
  and respects max_results.
- Single-contrast verdict: skipped phases do not penalise verdict.
"""
...
# =============================================================================
# Frozen Dataclasses with Mutable Fields
# =============================================================================
...
# =============================================================================
# Unbounded Neo4j Result Sets — Chunked Queries
# =============================================================================
...
# =============================================================================
# Verdict Over-Conservative Downgrade for Single-Contrast
# =============================================================================
