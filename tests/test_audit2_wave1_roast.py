"""
Tests for Audit Wave 1 ROAST set statistic corrections.

Validates fixes for:
- SET-TEST-1:  MEAN statistic for MIXED alternative uses signed z, not |z|.
- SET-TEST-2:  FLOORMEAN for UP/DOWN applies floor to small z-scores.
- SET-TEST-7:  MEAN50 selects top 50% by |z| (unweighted), not by w*z.
- SET-TEST-11: Sample weights applied to expression data Y before QR projection.
...
# =============================================================================
# SET-TEST-1: MEAN statistic for MIXED alternative
# =============================================================================


class TestSetTest1MeanMixed:
...
# =============================================================================
# SET-TEST-2: FLOORMEAN for UP/DOWN applies the floor
# =============================================================================


class TestSetTest2FloormeanFloor:
...
# =============================================================================
# SET-TEST-7: MEAN50 selects top 50% by |z|, not w*z
# =============================================================================


class TestSetTest7Mean50Selection:
...
# =============================================================================
# SET-TEST-11: Sample weights applied to expression data Y
# =============================================================================


class TestSetTest11SampleWeights:
