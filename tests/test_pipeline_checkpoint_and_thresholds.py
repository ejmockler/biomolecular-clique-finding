"""Tests for pipeline failure thresholds, checkpoint/resume, and configurable constants.

Covers:
- Failure threshold tracking in run_stratified_analysis()
- Checkpoint/resume in validate_baselines orchestrator
- compute_verdict() docstring design-asymmetry documentation
- Configurable constants (neg_ctrl_percentile, specificity-z-threshold, etc.)
"""
...
# =========================================================================
# Checkpoint/resume in validate_baselines
# =========================================================================
...
# =========================================================================
# Docstring for compute_verdict()
# =========================================================================

class TestVerdictDocstring:
    ...
    def test_docstring_replaces_alpha_squared_claim(self):
        ...
        docstring = ValidationReport.compute_verdict.__doc__
        # The new docstring uses bounded-FWER with rho-dependent formula
...
# =========================================================================
# Configurable verdict constants
# =========================================================================
...
class TestConfigurableConstants:
    ...
    def test_cli_threshold_arguments_registered(self):
        """Verify configurable threshold CLI arguments are registered with correct defaults."""
        from cliquefinder.cli.validate_baselines import register_parser
    ...
    def test_cli_threshold_custom_values(self):
        """Configurable threshold CLI arguments accept custom values."""
        from cliquefinder.cli.validate_baselines import register_parser
