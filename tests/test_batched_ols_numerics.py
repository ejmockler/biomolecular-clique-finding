"""
Tests for batched OLS numerics correctness.

MLX fast path for batched OLS:
...
class TestBatchedOlsGpuPerPattern:
    """Core correctness tests for per-pattern NaN grouping in batched OLS."""
