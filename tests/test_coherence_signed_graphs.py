#!/usr/bin/env python3
"""
Tests for CoherenceAnalyzer signed graph construction and permutation null.

- Permutation null tests both positive and negative graphs
- Stale _corr_cache attribute removed
- build_signed_graphs vectorized implementation correctness
"""
...
class TestPermutationNullNegativeGraph:
    """permutation_null should test negative graph when requested."""
...
class TestAnalyzeCoherenceNegPermutation:
    """analyze_coherence should run permutation_null for negative graph too."""
...
class TestCorrCacheRemoved:
    """CoherenceAnalyzer should not have _corr_cache attribute."""
...
class TestBuildSignedGraphsVectorized:
    """build_signed_graphs should produce correct results via vectorized path."""
