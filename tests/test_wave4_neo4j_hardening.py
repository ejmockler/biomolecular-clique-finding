"""Tests for Neo4j/knowledge graph hardening (Audit II Wave 4: KG-1..KG-4).

KG-1: get_downstream_targets Cypher has server-side LIMIT via max_results.
KG-2: discover_regulators passes remaining budget as per-chunk LIMIT.
KG-3: Exponential backoff with jitter on retryable connection errors.
KG-4: CoGExClient supports context manager protocol (with ... as client).
"""
...
# ===========================================================================
# KG-1: get_downstream_targets server-side LIMIT
# ===========================================================================

class TestKG1DownstreamTargetsLimit:
...
# ===========================================================================
# KG-2: discover_regulators server-side LIMIT per chunk
# ===========================================================================

class TestKG2DiscoverRegulatorsChunkLimit:
...
# ===========================================================================
# KG-3: Exponential backoff with jitter
# ===========================================================================

class TestKG3ExponentialBackoff:
