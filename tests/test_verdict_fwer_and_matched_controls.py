"""Tests for FWER docstring accuracy and cached matched control sets.

Validates:
- compute_verdict docstring uses bounded-FWER language with rho-dependent
  formulas instead of the incorrect alpha^2 claim.
- Matched z-scores use the SAME gene sets as matched p-values (cached
  from first pass), not freshly sampled sets.
"""
...
# ===================================================================
# Cached matched control sets
# ===================================================================


class TestCachedMatchedSets:
