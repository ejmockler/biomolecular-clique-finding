"""Tests for concordance NaN robustness and validation verdict edge cases.

Covers:
- robust_hits() NaN poisoning from failed methods
- wide_format() include_invalid parameter
- Verdict "refuted" gap when Phase 3 not run
- Negative controls docstring correctness
"""
...
# ---------------------------------------------------------------------------
# robust_hits() tolerates failed (all-NaN) methods
# ---------------------------------------------------------------------------


class TestRobustHitsNaNTolerance:
    """robust_hits() should not be poisoned by a failed method."""
...
# ---------------------------------------------------------------------------
# wide_format() invalid result filtering
# ---------------------------------------------------------------------------


class TestWideFormatInvalidFiltering:
    """wide_format() filters invalid results by default."""
...
# ---------------------------------------------------------------------------
# Verdict "inconclusive" when Phase 3 missing (not failed)
# ---------------------------------------------------------------------------


class TestVerdictPhase3Missing:
    """Phase 1 passes + Phase 3 not run gives 'inconclusive', not 'refuted'."""
