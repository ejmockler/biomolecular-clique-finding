"""
Tests for statistical documentation conventions.

Covers:
- SpecificityResult null_corr as top-level field + docstring notes
- P-value sidedness documentation in label_permutation,
  permutation_framework, and rotation modules
- FDR docstring revision in rotation.py
"""
...
# ============================================================================
# Specificity null_corr promotion and docstring notes
# ============================================================================

class TestNullCorrelationField:
    """null_corr should be a top-level field in SpecificityResult dict."""
...
# ============================================================================
# P-value sidedness documentation
# ============================================================================

class TestPValueSidednessDocstrings:
    """Each module should document its p-value sidedness convention."""
    ...
    def test_validation_report_sidedness_comment(self):
        ...
        assert "sidedness" in source.lower(), (
            "compute_verdict should have a comment about p-value sidedness"
        )


# ============================================================================
# FDR docstring revision
# ============================================================================

class TestFDRDocstrings:
    """FDR docstrings should mention Benjamini-Hochberg for multiple testing."""
