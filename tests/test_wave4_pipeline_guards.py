"""
Tests for Audit II Wave 4 pipeline guard / security findings.

Covers:
- VAL-3: Checkpoint resume preserves protein_df
- CLI-6: Guard on zero common samples
- CLI-7: Division by zero when ensembl_ids empty
- SEC-9: GO URLs use HTTPS
- SEC-11: Deterministic cache keys (hashlib, not hash())
"""
...
class TestVAL3CheckpointProteinDf:
...
class TestCLI6ZeroCommonSamples:
...
class TestSEC11DeterministicCacheKeys:
