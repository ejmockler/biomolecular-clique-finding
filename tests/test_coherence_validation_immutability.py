"""Tests for coherence significance, validation verdicts, and data immutability."""
...
# =============================================================================
# Community significance requires both p-value and quality
# =============================================================================


class TestCommunityIsSignificant:
    """is_significant requires BOTH graph-level p-value AND community quality."""
...
class TestFailedPhaseVerdict:
    """Phase 1 status='failed' should yield 'inconclusive', not 'refuted'."""
...
class TestFrozenFraction:
    """frozen_fraction field on LabelPermutationResult."""
...
class TestComputeCorrNaNHandling:
    """_compute_corr handles NaN and diagonal internally."""
...
class TestGetCliqueDataReadOnly:
    """get_clique_data returns read-only array."""
...
class TestBioMatrixImmutable:
    """BioMatrix.data is read-only."""
...
class TestNegativeControlToDictGuard:
    """to_dict doesn't crash on empty competitive z scores."""
...
class TestMatchWithinSign:
    """Cross-condition matching only matches within same sign."""
...
class TestEmptyBioMatrixRepr:
    """__repr__ doesn't crash on empty BioMatrix."""
