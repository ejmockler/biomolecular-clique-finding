"""
Audit II Wave 1 — Statistical Formula Correctness Tests

Validates all 10 Wave 1 fixes against reference implementations.

STAT-CORE-1: VSN MLX NaN reference (nanmean equivalent)
STAT-CORE-6: EB p-values always use t-distribution (never Normal)
STAT-CORE-10: Li-Ji M_eff uses full M eigenvalues
GPU-1: fit_f_dist s0_sq = mean(sigma2) when d0=inf
GPU-2: trigamma_inverse R limma reciprocal Newton
GPU-8: Per-feature df array for EB hyperparameters
SET-TEST-1: MEAN MIXED uses signed z (two-sided via |null|>=|obs|)
SET-TEST-2: FLOORMEAN UP/DOWN applies floor before zeroing
SET-TEST-7: MEAN50 selects by |z| not w*z
SET-TEST-11: Sample weights applied to Y in rotation
"""
...
# =============================================================================
# STAT-CORE-1: VSN MLX NaN Reference
# =============================================================================
...
class TestVSNNanReference:
    ...
    def test_mlx_nanmean_matches_numpy(self):
        """STAT-CORE-1: MLX VSN reference should match np.nanmean with NaN data."""
        try:
...
# =============================================================================
# STAT-CORE-6: Always use t-distribution for p-values
# =============================================================================
...
class TestAlwaysTDistribution:
    ...
    def test_t_vs_normal_divergence_small_df(self):
        """STAT-CORE-6: For small df, t and Normal give very different p-values."""
...
class TestLiJiMeff:
    ...
    def test_li_ji_uses_full_M(self):
        """STAT-CORE-10: Li-Ji should use all M eigenvalues, not filtered subset."""
...
# =============================================================================
# GPU-1: fit_f_dist s0_sq when d0=inf
# =============================================================================
...
class TestFitFDistInfD0:
    ...
    def test_s0_sq_is_mean_not_geometric(self):
        """GPU-1: When d0=inf, s0_sq should be arithmetic mean of sigma2."""
...
# =============================================================================
# GPU-2: trigamma_inverse R limma Alignment
# =============================================================================
...
class TestTrigammaInverse:
    ...
    def test_edge_cases(self):
        """GPU-2: Edge cases should not crash or produce invalid values."""
        from cliquefinder.stats.permutation_gpu import trigamma_inverse
    ...
    def test_asymptotic_threshold_1e7(self):
        """GPU-2: Asymptotic threshold should be 1e7 (matching R limma)."""
        from cliquefinder.stats.permutation_gpu import trigamma_inverse
...
class TestPerFeatureDf:
    ...
    def test_array_df_accepted(self):
        """GPU-8: fit_f_dist should accept array df without error."""
        from cliquefinder.stats.permutation_gpu import fit_f_dist
...
# =============================================================================
# SET-TEST-1: MEAN MIXED Uses Signed z
# =============================================================================
...
class TestMeanMixedSignedZ:
    ...
    def test_mean_mixed_is_signed(self):
        """SET-TEST-1: MEAN MIXED should return signed (not absolute) mean."""
    ...
    def test_mean_mixed_pvalue_two_sided(self):
        """SET-TEST-1: P-value for MEAN MIXED uses |null| >= |obs|."""
        from cliquefinder.stats.rotation import (
...
# =============================================================================
# SET-TEST-2: FLOORMEAN Applies Floor Before Zeroing
# =============================================================================
...
class TestFloormeanFloor:
    ...
    def test_floormean_up_floors_positive_z(self):
        """SET-TEST-2: FLOORMEAN UP should floor positive z at sqrt(q)."""
        from cliquefinder.stats.rotation import (
    ...
    def test_floormean_down_floors_negative_z(self):
        """SET-TEST-2: FLOORMEAN DOWN should floor |z| for negative z."""
        from cliquefinder.stats.rotation import (
            _compute_floormean_stat, Alternative,
        )
...
class TestMean50Selection:
    ...
    def test_mean50_selects_by_abs_z(self):
        """SET-TEST-7: Top 50% by |z| not by w*z."""
        from cliquefinder.stats.rotation import (
...
# =============================================================================
# SET-TEST-11: Sample Weights Applied to Y
# =============================================================================
...
class TestSampleWeightsOnY:
    ...
    def test_w_sqrt_vec_stored_in_precomputed(self):
        """SET-TEST-11: RotationPrecomputed stores w_sqrt_vec."""
    ...
    def test_weights_applied_to_y_in_extract(self):
        """SET-TEST-11: extract_gene_effects applies w_sqrt_vec to Y."""
        from cliquefinder.stats.rotation import (
...
class TestWave1Integration:
    """Integration tests verifying the combined Wave 1 fixes."""
