"""Tests for memory-mapped process pool workers and Neo4j typed exceptions.

Verifies that ProcessPoolExecutor workers load expression matrices via
memory-mapped .npy files instead of pickle-serialized copies.

Verifies that CoGExClient._execute_query() uses typed Neo4j exception
classes (ServiceUnavailable, SessionExpired, TransientError) for
...
# =============================================================================
# Memory-Mapped Arrays for Process Pool Workers
# =============================================================================
...
# =============================================================================
# Neo4j Typed Exception Handling
# =============================================================================
