"""
Tests for R limma empirical Bayes formula alignment.

Validates four aspects of the EB pipeline against R limma reference:

- Anti-conservative p-values: always use t-distribution, never Normal
  approximation. Tests both differential.py and permutation_gpu.py paths.
- fit_f_dist s0_sq: arithmetic mean of sigma2 when d0=inf (not geometric).
- trigamma_inverse Newton formula: inverse property, edge cases, asymptotic
  threshold at 1e7 (matching R limma).
- Per-feature df array for EB hyperparameter estimation: heterogeneous df
  from varying missing data, df >= 2 clipping.
"""
...
# =============================================================================
# P-values must always use t-distribution
# =============================================================================


class TestDifferentialTDistPvalues:
...
class TestPermutationGpuTDistPvalues:
    """Verify permutation_gpu.py p-value path also uses t-distribution.

    Checks that the p-value computation uses t.sf instead of norm.sf
    for unmoderated paths.
    """
...
# =============================================================================
# fit_f_dist s0_sq with d0=Inf
# =============================================================================


class TestFitFDistS0SqInf:
...
# =============================================================================
# trigamma_inverse Newton formula and asymptotic threshold
# =============================================================================
...
# =============================================================================
# Per-feature df array for EB hyperparameter estimation
# =============================================================================
...
class TestPerFeatureDf:
    ...
    def test_per_feature_df_affects_eb_priors(self):
        ...
        The old code used int(np.median(df_valid)); the corrected code
        uses the full per-feature array.
        """
...
class TestCombinedFixesIntegration:
    ...
    def test_small_sample_full_pipeline(self):
        ...
        This exercises all four components together:
        - Per-feature df array
        - Correct s0_sq if d0=inf
        - trigamma_inverse accuracy
