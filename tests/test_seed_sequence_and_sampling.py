"""
Tests for SeedSequence adoption, atomic file writes, and vectorized random
sampling infrastructure.

Covers:
- SeedSequence: seed arithmetic replaced by SeedSequence.spawn().
- Atomic file writes: atomic_write_json and atomic_write_text.
- Vectorized sampling: argpartition-based precompute_random_indices.
"""
