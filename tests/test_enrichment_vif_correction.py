"""Tests for competitive z-score SE denominator and Camera VIF correction.

Validates that:
- The z-score denominator uses SE = sigma/sqrt(k)
- The Camera VIF = 1 + (k-1)*rho_bar inflates SE correctly
...
class TestZScoreSEDenominator:
    """Competitive z-score uses SE = sigma/sqrt(k) as denominator."""
...
class TestCameraVIF:
    """Camera VIF adjusts for inter-gene correlation."""
