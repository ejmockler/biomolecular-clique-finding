"""Tests for regulatory coherence analysis corrections.

Covers:
- Phipson-Smyth correction for permutation p-values
- Deterministic community detection via seeded RNG
- Per-community modularity contribution
- Spearman 2-gene edge case
- CorrelationSign.BOTH removal
- Narrowed exception handling in analyze_all_conditions
"""
