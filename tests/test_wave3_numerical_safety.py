"""
Tests for Audit II Wave 3 numerical safety fixes:

STAT-CORE-5: Deprecated binom_test replaced with binomtest
    - Verify binomtest is called (not binom_test)
    - Verify result matches expected p-value for known inputs

STAT-CORE-7: logsumexp NaN propagation
    - Test logsumexp with NaN values produces correct result
    - Test all-NaN column returns NaN

STAT-CORE-11: AFT imputation -inf draw prevention
    - Verify uniform draw lower bound is > 0
    - Verify ppf result is always finite

STAT-CORE-15: Mixed model fallback df off-by-one
    - Test that fallback df computation matches n_obs - n_params (not n_obs - n_params - 1)
"""
...
# =============================================================================
# STAT-CORE-5: binomtest replaces deprecated binom_test
# =============================================================================
